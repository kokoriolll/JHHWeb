...
$(document).ready(function(){function a(a){$(a.target).prev(".panel-heading").find(".panel-title a").toggleClass("active").find("i.fa").toggleClass("fa-plus-square fa-minus-square")}$(".navbar-toggle").on("click",function(){$(this).toggleClass("active")}),$("body").scrollspy({target:"#page-nav-wrapper",offset:100}),$(".scrollto").on("click",function(a){var o=this.hash;a.preventDefault(),$("body").scrollTo(o,800,{offset:-62,axis:"y"})}),$(".scrollto-no-offset").on("click",function(a){var o=this.hash;a.preventDefault(),$("body").scrollTo(o,800,{offset:0,axis:"y"})}),$(window).on("scroll",function(){if($("#page-nav-wrapper").removeClass("fixed"),$("#page-nav-wrapper").length){var a=$(this).scrollTop();$("#page-nav-wrapper").offset().top>a?($("#page-nav-wrapper").removeClass("fixed"),$("body").removeClass("sticky-page-nav")):($("#page-nav-wrapper").addClass("fixed"),$("body").addClass("sticky-page-nav"))}}),$("#modal-video .close").on("click",function(){$("#modal-video iframe").attr("src",$("#modal-video iframe").attr("src"))}),$(".panel").on("hidden.bs.collapse",a),$(".panel").on("shown.bs.collapse",a),$("#signup-link").on("click",function(a){$("#login-modal").modal("toggle"),$("#signup-modal").modal(),a.preventDefault()}),$("#login-link").on("click",function(a){$("#signup-modal").modal("toggle"),$("#login-modal").modal(),a.preventDefault()}),$("#back-to-login-link").on("click",function(a){$("#resetpass-modal").modal("toggle"),$("#login-modal").modal(),a.preventDefault()}),$("#resetpass-link").on("click",function(a){$("#login-modal").modal("hide"),a.preventDefault()}),$("#testimonials-carousel").carousel({interval:8e3})});
